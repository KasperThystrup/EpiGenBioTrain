...
#setwd("I:EpiLinx/EpiLinx\ v1.3.2\ -\ LPR3\ -\ under construction")
library(lubridate)
library(tidyverse)
library(ggraph)
library(igraph)
...
########################################################################
# Dashboard EpiLinx v. 1.3.2 for LPR 3 data.
# Version: "Divisible by... Few"
# Start: 11-03-19
# Latest mod: 15-04-20
# Author: ANEH, SSI
########################################################################
                    ...
                    fluidRow(
                      column(width=12,
                             selectizeInput("patient",
                                            ...
                                            multiple=F),
                             hr(),
                             #h4(style="color:#009999","Hospitalisations"),
...
server <- function(input, output,session) {
  ...
  output$welcome2 <- renderText({paste("Please submit .csv or .xlsx file for analysis.")})
